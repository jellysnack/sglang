...
class Envs:
    ...
    # CP KV LayerSplit
    # Per-family ablation knobs; omit --enable-cp-kv-layer-split to disable the feature.
    SGLANG_CP_KV_LAYER_SPLIT_DSV4_DISABLE_SWA_SHARDING = EnvBool(False)
    SGLANG_CP_KV_LAYER_SPLIT_DSV4_DISABLE_C4_SHARDING = EnvBool(False)
    SGLANG_CP_KV_LAYER_SPLIT_DSV4_DISABLE_C128_SHARDING = EnvBool(False)
    SGLANG_CP_KV_LAYER_SPLIT_DSV4_DISABLE_C4_INDEXER_SHARDING = EnvBool(False)
    SGLANG_CP_KV_LAYER_SPLIT_DSV4_ENABLE_SWA_BROADCAST_OVERLAP = EnvBool(True)
    SGLANG_CP_KV_LAYER_SPLIT_DSV4_DISABLE_ASYNC_NON_SWA_BROADCAST = EnvBool(False)
