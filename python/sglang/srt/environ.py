...
class Envs:
    ...
    SGLANG_OPT_SWA_RECOMPUTE_WINDOW = EnvBool(False)
    SGLANG_SWA_RECOMPUTE_GATE_MULTIPLIER = EnvFloat(2.0)
    SGLANG_DEBUG_FORCE_SWA_RECOMPUTE = EnvBool(False)
    SGLANG_DEBUG_SWA_RECOMPUTE_CP_ADMISSION = EnvBool(False)
